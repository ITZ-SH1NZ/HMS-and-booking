...
export default async function BookingDetailPage({
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10">
      {/* Back Navigation (Hidden during Print) */}
      ...
      <div id="receipt-print-area" className="space-y-6">
        ...
        <div className="flex items-start justify-between gap-3 border-b border-slate-200/60 pb-5">
          <div>
            ...
            {/* Prominent Short Booking ID */}
            <div className="mt-4 flex flex-col gap-0.5">
              <p className="text-sm font-bold text-slate-850">
                Booking ID: <span className="font-mono text-brand-700 select-all uppercase">{booking.id.slice(0, 8).toUpperCase()}</span>
              </p>
        ...
        <StaggerContainer className="space-y-5">
          {/* Stay Details */}
          <StaggerItem>
            <section className="rounded-3xl border border-slate-250/60 bg-white p-6 shadow-xs transition duration-300">
