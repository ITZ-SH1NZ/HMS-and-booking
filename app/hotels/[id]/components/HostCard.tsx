  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md transition duration-300">
      <div className="flex items-center gap-4">
        {/* Initials Avatar */}
        <div className="relative flex h-16 w-16 shrink-0 items-center justify-center rounded-full bg-gradient-to-tr from-rose-500 to-rose-600 font-bold text-white text-xl tracking-wider shadow-inner">
          {initials}
          {isSuperhost && (
            <span className="absolute -bottom-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full bg-amber-500 text-white shadow-md border border-white">
        ...
        <div>
          ...
          {isSuperhost && (
            <span className="inline-flex items-center gap-1 mt-1 text-[11px] font-bold text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full border border-amber-100 uppercase tracking-wide">
              Superhost
            </span>
          )}
        </div>
